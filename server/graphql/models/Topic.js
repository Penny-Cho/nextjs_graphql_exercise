...
class Topic {
    ...
    //.populate('user')는 몽고디비에서 user 안에 담긴 author 하위의 값인 avatar, username 이런 식으로 못가져오고 아이디만 ref할 수 있기 때문에 populate라는 것을 써서 graphql에서 nesting된 데이터들을 가져올 수 있게 처리함.
